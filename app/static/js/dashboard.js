...
// --- FUNCIÓN AUDITORÍA ATC (VERSIÓN FINAL V3) ---
    window.openATCModal = async function(dbId, externalId) {
        ...
        try {
            ...
            let productsHtml = ''; // <--- CAMBIO AQUÍ (Antes decía itemsHtml)
                ...
                // CASO C: MIXTO (DETECTIVE)
                    ...
                    if (items.length <= 15) {
                        ...
                        if (resultIndices) {
                            ...
                            methodUsed = "exact";
                            console.log("🕵️‍♂️ Detective IVA: Match encontrado");
                        } else {
